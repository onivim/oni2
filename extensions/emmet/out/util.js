...
exports.trimQuotes = exports.isStyleAttribute = exports.getEmbeddedCssNodeIfAny = exports.getCssPropertyFromDocument = exports.getCssPropertyFromRule = exports.iterateCSSToken = exports.getEmmetConfiguration = exports.sameNodes = exports.getNodesInBetween = exports.findPrevWord = exports.findNextWord = exports.getDeepestNode = exports.getInnerRange = exports.getHtmlNode = exports.allowedMimeTypesInScriptTag = exports.getNode = exports.parsePartialStylesheet = exports.parseDocument = exports.getEmmetMode = exports.getMappingForIncludedLanguages = exports.validate = exports.isStyleSheet = exports.LANGUAGE_MODES = exports.updateEmmetExtensionsPath = exports.getEmmetHelper = void 0;
...
function updateEmmetExtensionsPath() {
    ...
    if (_currentExtensionsPath !== extensionsPath) {
        ...
        if (!vscode.workspace.workspaceFolders) {
            ...
            _emmetHelper.updateExtensionsPath(extensionsPath, rootPath).then(null, (err) => vscode.window.showErrorMessage(err));
        }
    }
}
