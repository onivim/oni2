    ...
    class LanguageProvider extends dispose_1.Disposable {
        ...
        async registerProviders() {
            ...
            await Promise.all([
                ...
                Promise.resolve().then(() => require('./features/semanticTokens')).then(provider => this._register(provider.register(selector, this.client))),
                Promise.resolve().then(() => require('./features/callHierarchy')).then(provider => this._register(provider.register(selector, this.client))),
            ]);
        }
