...
class DiskTypeScriptVersionProvider {
    ...
    get bundledVersion() {
        ...
        vscode.window.showErrorMessage(versionProvider_1.localize('noBundledServerFound', 'VS Code\'s tsserver was deleted by another application such as a misbehaving virus detection tool. Please reinstall VS Code.'));
