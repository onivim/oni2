...
class GitTimelineProvider {
    constructor(model) {
        ...
        this.disposable = vscode_1.Disposable.from(model.onDidOpenRepository(this.onRepositoriesChanged, this));
    ...
    async provideTimeline(uri, options, _token) {
        ...
        const items = commits.map((c, i) => {
            ...
            const item = new GitTimelineItem(c.hash, (_b = (_a = commits[i + 1]) === null || _a === void 0 ? void 0 : _a.hash) !== null && _b !== void 0 ? _b : `${c.hash}^`, c.message, (_c = date === null || date === void 0 ? void 0 : date.getTime()) !== null && _c !== void 0 ? _c : 0, c.hash, 'git:file:commit');
