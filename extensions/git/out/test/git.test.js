...
This is a commit message.`;
            assert.deepEqual(git_1.parseGitCommit(GIT_OUTPUT_SINGLE_PARENT), {
...
This is a commit message.`;
            assert.deepEqual(git_1.parseGitCommit(GIT_OUTPUT_MULTIPLE_PARENTS), {
                hash: '52c293a05038d865604c2284aa8698bd087915a1',
                message: 'This is a commit message.',
...
This is a commit message.`;
            assert.deepEqual(git_1.parseGitCommit(GIT_OUTPUT_NO_PARENTS), {
                hash: '52c293a05038d865604c2284aa8698bd087915a1',
                message: 'This is a commit message.',
                parents: [],
                authorEmail: 'john.doe@mail.com',
