...
suite('git', () => {
    ...
    suite('parseGitmodules', () => {
        test('empty', () => {
            assert.deepEqual(git_1.parseGitmodules(''), []);
        });
        test('sample', () => {
...
This is a commit message.\x00`;
            assert.deepEqual(git_1.parseGitCommits(GIT_OUTPUT_SINGLE_PARENT), [{
...
This is a commit message.\x00`;
            assert.deepEqual(git_1.parseGitCommits(GIT_OUTPUT_MULTIPLE_PARENTS), [{
                    hash: '52c293a05038d865604c2284aa8698bd087915a1',
                    message: 'This is a commit message.',
...
This is a commit message.\x00`;
            assert.deepEqual(git_1.parseGitCommits(GIT_OUTPUT_NO_PARENTS), [{
                    hash: '52c293a05038d865604c2284aa8698bd087915a1',
                    message: 'This is a commit message.',
                    parents: [],
                    authorDate: new Date(1580811030000),
...
100644 blob 56ec42c9dc6fcf4534788f0fe34b36e09f37d085  261186	what.txt2`;
            const output = git_1.parseLsTree(input);
...
100644 56ec42c9dc6fcf4534788f0fe34b36e09f37d085 0	what.txt2`;
            const output = git_1.parseLsFiles(input);
            assert.deepEqual(output, [
    ...
    suite('splitInChunks', () => {
        test('unit tests', function () {
            assert.deepEqual([...util_1.splitInChunks(['hello', 'there', 'cool', 'stuff'], 6)], [['hello'], ['there'], ['cool'], ['stuff']]);
            assert.deepEqual([...util_1.splitInChunks(['hello', 'there', 'cool', 'stuff'], 10)], [['hello', 'there'], ['cool', 'stuff']]);
            assert.deepEqual([...util_1.splitInChunks(['hello', 'there', 'cool', 'stuff'], 12)], [['hello', 'there'], ['cool', 'stuff']]);
            assert.deepEqual([...util_1.splitInChunks(['hello', 'there', 'cool', 'stuff'], 14)], [['hello', 'there', 'cool'], ['stuff']]);
            assert.deepEqual([...util_1.splitInChunks(['hello', 'there', 'cool', 'stuff'], 2000)], [['hello', 'there', 'cool', 'stuff']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 1)], [['0'], ['01'], ['012'], ['0'], ['01'], ['012'], ['0'], ['01'], ['012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 2)], [['0'], ['01'], ['012'], ['0'], ['01'], ['012'], ['0'], ['01'], ['012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 3)], [['0', '01'], ['012'], ['0', '01'], ['012'], ['0', '01'], ['012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 4)], [['0', '01'], ['012', '0'], ['01'], ['012', '0'], ['01'], ['012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 5)], [['0', '01'], ['012', '0'], ['01', '012'], ['0', '01'], ['012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 6)], [['0', '01', '012'], ['0', '01', '012'], ['0', '01', '012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 7)], [['0', '01', '012', '0'], ['01', '012', '0'], ['01', '012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 8)], [['0', '01', '012', '0'], ['01', '012', '0', '01'], ['012']]);
            assert.deepEqual([...util_1.splitInChunks(['0', '01', '012', '0', '01', '012', '0', '01', '012'], 9)], [['0', '01', '012', '0', '01'], ['012', '0', '01', '012']]);
        });
    });
});
