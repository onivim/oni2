...
module CompletionProvider = {
  type t = (Buffer.t, CompletionMeet.t, Position.t) => option(Lwt.t(list(CompletionItem.t)));
};
...
let requestCompletions = (~buffer: Buffer.t, ~meet: CompletionMeet.t, ~position: Position.t, lf: t) => {

  let promises = lf.completionProviders
...
let registerCompletionProvider = (completionProvider: CompletionProvider.t, v: t) => {
