  ...
  (module
   {
     ...
     let%test "basic case" = {
       let title = ofString("prefix${variable1}${separator}${variable2}postfix");
       toString(title, simpleMap) == "prefixrv1 - rv2postfix";
     };
     let%test "nested variable missing case" = {
       let title = ofString("prefix${variable1}${separator}${missingVariable}${separator}${variable2}postfix");
       toString(title, simpleMap) == "prefixrv1 - rv2postfix";
     };
  })
