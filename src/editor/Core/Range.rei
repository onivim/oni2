...
open Types;
  ...
  let createFromPositions: (~startPosition: Position.t, ~endPosition: Position.t, unit) => t;

  let create: (~startLine: Index.t, ~startCharacter: Index.t, ~endLine: Index.t, ~endCharacter: Index.t, unit) => t;
