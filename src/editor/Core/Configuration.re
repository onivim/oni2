...
let getValueOpt = (~fileType=None, selector: ConfigurationValues.t => option('a), configuration: t) => {
...
let getValue = (~fileType=None, selector: (ConfigurationValues.t) => option('a), configuration: t) => {
