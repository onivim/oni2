...
module ExtHostClient = ExtensionHostClient;
module ExtHostInitData = ExtensionHostInitData;
module ExtHostProtocol = ExtensionHostProtocol;
module ExtHostTransport = ExtensionHostTransport;
