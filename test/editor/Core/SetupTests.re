...
describe("Setup", ({test, _}) =>
  test("ofString", ({expect}) => {
    let setupInfo = "{neovim:\"/path/to/neovim\",node:\"/path/to/node\",textmateService:\"/path/to/textmate\",bundledExtensions:\"/path/to/extensions\",rg:\"/path/to/rg\", extensionHost: \"/path/to/exthost\"}";
