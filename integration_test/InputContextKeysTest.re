...
runTest(
  ...
  (dispatch, wait, _) => {
    ...
    wait(
      ~name="Validate editor has 'editorTextFocus' and 'normalMode' context keys",
      (state: State.t) => {
    ...
    wait(
      ~name="Validate terminal has 'editorTextFocus' and 'normalMode' context keys",
      (state: State.t) => {
