...
./_staging/linuxdeploy-x86_64.AppImage --custom-apprun=scripts/linux/AppRun -e _release/linux/bin/Oni2 --appdir _release/Onivim2.AppDir -d _release/linux/Onivim2.desktop -i _release/linux/Onivim2.png
